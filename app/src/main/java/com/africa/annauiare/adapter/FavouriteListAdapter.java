 ...
 */
public class FavouriteListAdapter<T> extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public FavouriteListAdapter(List<T> productLists, Context mContext) {
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
        if(holder instanceof EventViewHolder){
            ...
            Picasso.with(mContext)
                    ...
                    .into(((FavouriteListAdapter.EventViewHolder) holder).tool_image_view);
