...
public class CategorySearchAdapter<T> extends RecyclerView.Adapter<RecyclerView.ViewHolder>{
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
        if(holder instanceof EventViewHolder){
            ...
            try {
                if (((Businesse)dataItem).getOfficeLocation()!=null && !((Businesse)dataItem).getOfficeLocation().equals("")){
                    ...
                    ((EventViewHolder) holder).textView_business_address.setText("No Address found");
                }

                ((EventViewHolder) holder).textView_business_category.setText(((Businesse)dataItem).getCategory().toString());
                if (!((Businesse)dataItem).getLogo().equals(""))
                    ...
                    ((EventViewHolder) holder).imageView_business_image.setImageResource(R.drawable.no_image_available);
            }catch (Exception ex){
                ex.printStackTrace();
            }
