 ...
 */
public class ImageListAdapter<T> extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public ImageListAdapter(List<T> productLists, Context mContext) {
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
        if(holder instanceof EventViewHolder){
            ...
            Picasso.with(mContext)
                    .load(((MyImage)dataItem).getImage_url())
                    .resize(100,100)
                    .centerInside()
                    .placeholder(R.drawable.placeholder)
                    .error(R.drawable.no_image_available)
                    .into(((ImageListAdapter.EventViewHolder) holder).tool_image_view);
        }else{
    ...
    public static class EventViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener{
        ...
        public EventViewHolder(View itemView) {
            super(itemView);
            tool_image_view = (ImageView) itemView.findViewById(R.id.id_favourite_image);
            title_view = (TextView) itemView.findViewById(R.id.id_favourite_text);
